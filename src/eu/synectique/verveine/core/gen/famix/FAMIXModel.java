...
public class FAMIXModel {
    ...
    public static void importInto(MetaRepository metamodel) {
		metamodel.with(eu.synectique.verveine.core.gen.famix.EclipsePlugin.class);
		...
		metamodel.with(eu.synectique.verveine.core.gen.famix.EclipsePluginImport.class);
		...
		metamodel.with(eu.synectique.verveine.core.gen.famix.EclipsePluginGroup.class);
