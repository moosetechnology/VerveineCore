...
public class FAMIXModel {
    ...
    public static void importInto(MetaRepository metamodel) {
		metamodel.with(fr.inria.verveine.core.gen.famix.EclipsePlugin.class);
		...
		metamodel.with(fr.inria.verveine.core.gen.famix.EclipsePluginImport.class);
		...
		metamodel.with(fr.inria.verveine.core.gen.famix.EclipsePluginGroup.class);
		...
		metamodel.with(fr.inria.verveine.core.gen.famix.TypeAlias.class);
